...
| 3 — local monitor and synthetic contract benchmark shipped; field validation pending | Replay-verified pilot history, freshness and restatement alerts, structural proposal suite | Real export cadence, measured runtime/query cost, labeled false-alert and semantic-support tests, reviewer acceptance |
